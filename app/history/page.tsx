  ...
  const timelineEvents = [
    {
      year: '1924年',
      title: '創業',
      description: '創業者の富士田太郎が、看板商品「ぽっぽ焼き」は、当時、新潟県の北部に位置する城下町「新発田市」で、町民の焼きねり菓子として考案されたものを独自に再解釈。政府の役人でもあった富士田太郎は、機密文章を運ぶ手段としてぽっぽ焼きの中に手紙を入れることを思いつく。当時「ポスト」の隠語であった「ぽっぽ」が名前に入っていることで、幕府の役人に密かに文書のことが伝わると考えた。また、カモフラージュのため、新潟と同様に9本入りをスタンダードとし、袋に入れ渡していた。しかし、幕府の役人たちは味に感動し、文書に気づかなかったと言われている。この時の菓子作りの技術を活かし、東京・下町で「富士屋菓子舗」として創業。「おとうさんのきもち」をモットーに、手頃な価格で質の良いお菓子を提供することを心がけた。'
    },
    {
      year: '1925年',
      title: '創業期の試練と革新',
    ...
    },
    {
      ...
      },
      {
        year: '1992年',
        title: '「おとうさんの逆襲」事件',
        description: '世間を騒がせた「おとうさんの逆襲」事件が発生。新商品の「超硬化ぽっぽ焼き」による入れ歯破損事件が発生。この危機を逆手に取り「やわらか食感シリーズ」を開発、高齢者層からの支持を獲得し、売上過去最高を記録。'
      },
      {
        year: '1998年',
        title: 'ぽっぽ焼き100時間テレビ',
